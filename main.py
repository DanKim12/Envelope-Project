...
while n!=4:
    ...
    for i in range(len(strategies)):
        print(i, strategies[i].__class__.__name__)
    n = input(f'enter your choice [0-{len(strategies)-1}] (len(strategies) to end):')
    if n.isdigit():
        n=int(n)
        if n==2:
            ...
            try:
                ...
                strategies[n].percent = 0.25

        if n!=4:
            strategies[n].play()
            strategies[n].display()
